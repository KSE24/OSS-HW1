...
> **OPTION**
* _+ 또는 -로 시작_
* _+ 또는 -로 시작하지 않는 옵션은 OptionString을 종료_

> **전역 변수의 활용**
* _getopts 함수는 호출될때마다 optind에서 처리 될 다음 인수의 인덱스를 배치하며, 쉘이 호출될때마다 optind는 1로 초기화됨_
...
|값|설명|
|:-:|-|
|0|OptionString에 의해 지정되거나 지정되지 않은 옵션 발견|
|>0|옵션의 끝에 도달했거나 오류 발생|
